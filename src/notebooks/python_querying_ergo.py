...
# **** a additional backward slashes to satisfy Python syntax.
HOMEDIR = os.environ["HOME"].replace("\\", "/")
ERGOROOT = HOMEDIR + "/ERGO/Ergo"
...
# Ergo/demos/family_obj.flr is a simple KB found in the Ergo installation.
